...
const MENU_SECTIONS: { title: string; items: MenuItem[] }[] = [
  {
    ...
    items: [
      ...
      { label: 'Order Search',     icon: 'search',         color: Colors.accent.blue, screen: 'OrderSearch',    description: 'Multi-field order search across all accounts' },
      { label: 'Saved Baskets',    icon: 'layers',         color: '#FFB547', screen: 'SavedBaskets',    description: 'Save, approve and execute order baskets' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Latency Monitor',  icon: 'pulse',          color: '#FF6B6B', screen: 'LatencyMonitor',  description: 'FIX routing latency per component (200ms threshold)' },
